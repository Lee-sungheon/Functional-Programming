...
// console.log(myPromise.all([promise, promise2]));
// myPromise.all([promise, promise2]).then(res => console.log(res));
// myPromise.allSettled([promise, promise2]).then(res => console.log(res)).catch(err => console.log(err));
myPromise.allSettled([promise3]).then(res => console.log(res)).catch(err => console.log(err));
